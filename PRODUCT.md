...
- **Principles:** zero install, zero account, zero cost. Private by construction: nothing leaves the device. No server and no responsibility for the maintainer. Simple: every feature earns its place in a rehearsal. Keyboard first on the practice screen.
- **Surfaces:** landing (first visit), script step, practice screen. All Operate mode.
- **Voice:** plain US English, calm and direct. No em or en dashes, no curly quotes.

The full specification is in `docs/PRD.md`.
